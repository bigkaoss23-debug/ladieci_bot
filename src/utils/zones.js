...
const ZONE_DELIVERY = [
  {
    id: "Q1", nome: "CENTRO + BUENAVISTA", tempoGiro: 15, maxOrdiniPerGiro: 4, costo: 2.50,
    polygon: [
  ...
  {
    id: "Q2", nome: "LAS MARINAS", tempoGiro: 18, maxOrdiniPerGiro: 2, costo: 2.50,
    polygon: [
  ...
  {
    id: "Q3", nome: "IES", tempoGiro: 12, maxOrdiniPerGiro: 5, costo: 2.50,
    polygon: [
  ...
  {
    id: "Q4", nome: "CORTIJOS", tempoGiro: 20, maxOrdiniPerGiro: 2, costo: 2.50,
    polygon: [
