...
const ACTION_POLICY_REGISTRY = Object.freeze([
  ...
  { action: 'backupSerata', acceptedCapabilities: ['service.session.backup'], legacyStatus: 'operator_shared_TIGHTENED', v3Phase: 'V3-A', note: 'FROZEN: system/owner only, not cashier, until a response contract proven to expose no financial data to Caja exists (source-verified, servizio.js:143-180: writes a full-day revenue+order snapshot).' },
