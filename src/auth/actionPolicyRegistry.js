...
const ACTION_POLICY_REGISTRY = Object.freeze([
  ...
  { action: 'rollEconomicPeriod', acceptedCapabilities: ['service.session.open_close'], legacyStatus: 'operator_shared', v3Phase: 'V3-A', note: 'P0-C2 — explicit, non-silent trigger of the non-destructive intraday economic boundary (roll_service_session_economic_v1). Never called automatically.' },
  { action: 'consolidateServicePeriod', acceptedCapabilities: ['service.session.open_close'], legacyStatus: 'operator_shared', v3Phase: 'V3-A', note: 'R-DAY4 — explicit, immutable Service Period economic checkpoint (consolidate_period_v1). Same capability/legacy class as rollEconomicPeriod immediately above; never a period-currency or order-intake gate.' },
