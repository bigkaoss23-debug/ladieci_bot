...
| 41 | 2026-07-29 → **V3-C** | 2026-07-29_v3c_auth_change_actor_role.sql | pending | 2026-07-29 | 0825d580cc96eb10 |  <!-- DRAFT — NOT APPLIED. Relaxes the hardcoded 1:1 auth_actors_actor_role_map CHECK to permit any non-owner actor to hold any role except admin/owner (owner stays pinned to admin; no row's role value changes — no UPDATE anywhere in this file). Creates auth_change_actor_role_v3: a dormant, owner-authorized, session-bound-idempotent RPC converting ONE non-owner actor to ONE of the 5 assignable V3 roles (cashier/waiter/kitchen/rider/shift_manager), auditing role_changed + session_invalidated on every real change. No Node code calls v3 yet — still completely unwired. -->
