...
| 40 | 2026-07-29 → **V3-B** | 2026-07-29_v3b_auth_set_actor_pin_v3.sql | pending | 2026-07-29 | f2e887c6dce6abe4 |  <!-- DRAFT — NOT APPLIED. Additive only: creates auth_set_actor_pin_v3 ALONGSIDE the still-untouched, still-sole-live auth_set_actor_pin_v2. Adds atomic dual-key fingerprint writes and removes v2's hardcoded 3-role closed-list pre-check (the authoritative row-based role check is unchanged). No Node code calls v3 yet. -->
