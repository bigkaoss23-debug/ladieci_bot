...
| 39 | 2026-07-29 → **V3-A** | 2026-07-29_v3a_access_control_foundation.sql | pending | 2026-07-29 | 4d3aae1ea98ba87c |  <!-- DRAFT — NOT APPLIED. Additive/foundation only: widens auth_actors.role vocabulary (reassigns the 4 legacy rows, owner->owner / operators->legacy_operator / rider unchanged), adds auth_actor_pin_fingerprints + access_management_idempotency (inert), widens auth_audit_event_chk. Does not lift the actor-id CHECK (V3-D) and does not touch table_sessions (V3-G). -->
