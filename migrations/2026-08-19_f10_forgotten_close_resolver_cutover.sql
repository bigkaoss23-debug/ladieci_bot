...
--
-- F-10.5 — wrapped in an explicit transaction (BEGIN/COMMIT) to match this
-- repository's own migration convention (e.g. row 92,
-- 2026-08-18_f7_opening_authority_cutover.sql), so the predecessor guard and
-- the function replacement are atomic together. This is the ONLY change
-- relative to the frozen, hash-pinned candidate file
-- (/Users/bigart/Downloads/ladieci-f10-certification/f10_forgotten_close_resolver_cutover.sql,
-- sha256 fe68cc760222f77a09c7ebb60657d82e7c67c108629b9690c2c71272cce44373)
-- -- the guard body and the function body below are byte-identical to it.
